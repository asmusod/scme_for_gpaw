...
c     Routine to calculate cross products of 3-vectors. r3 = r1 x r2
...
c
c     Subroutine to invert a 3x3 symmetrical matrix. Input:  x
c                                                    Output: y
c      
      real*8 x(3,3), y(3,3), det
...
c         print *, '2D'
         ...
         y(3,2) = -x(2,3)
         y(3,3) = x(2,2)
c         print '(A, $)', 'Error in inverse. Determinant ='
c         print *, det, x(1,1)
c         stop
      else 
c         print *, '3D'
...
c-----------------------------------------------------------------------
      ...
      implicit none
      integer ii, jj, iRot
      real*8 a, b, c, d, e, f, g, h, i, y(6,6)
      real*8 r1(3), r2(3), r3(3)
      real*8 r1a(3,3), r2a(3,3), r3a(3,3), det, detOld
      integer flag

      real*8 mF(3,3,3), sq2, oh
...
C         print *, 'Error in inv5(). Det = 0.'
      ...
      y(1,1) = -a*f*h + d*f*h + b*d*i - d*e*i - b*g*i + e*g*i + a*h*i
     $     - d*h*i
      ...
      y(2,2) = b*c*g - c*e*g - a*b*i + b*d*i - b*g*i + e*g*i + a*h*i -
     $     d*h*i 
      ...
      y(3,3) = c*d*e - b*d*f - c*e*g + d*f*h + b*d*i - d*e*i + e*g*i -
     $     d*h*i 
      y(3,4) = -c*d + c*g + d*i - g*i
      y(3,5) = -b*f + f*h + b*i - h*i
      y(3,6) = -c*f + c*i + f*i - i*i

      y(4,1) = -b*c*d + c*d*e + a*b*f - b*d*f + b*c*g - c*e*g - a*b*i
     $     + b*d*i
      ...
      y(5,2) = -b*c*d + c*d*e + a*b*f - b*d*f - a*f*h + d*f*h + b*d*i
     $     - d*e*i
      ...
      y(6,3) = -b*c*d + a*b*f + b*c*g - a*f*h - a*b*i + b*d*i - b*g*i
     $     + a*h*i
